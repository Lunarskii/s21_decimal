...
END_TEST
START_TEST(TEST_MUL_MANUAL_DOUBLE_VALUES5) {
...
END_TEST
START_TEST(TEST_MUL_MANUAL_DOUBLE_VALUES6) {
  s21_decimal x = {{55, 0, 0, 0}};
  s21_decimal y = {{55, 0, 0, 0}};
  s21_decimal result_test = {{302, 0, 0, 0}};
  s21_decimal result_mul = {0};
  setExponent(&x, 15);
  setExponent(&y, 14);
...
START_TEST(TEST_DIV_OVERFLOW_POSITIVE1) {
...
END_TEST
START_TEST(TEST_DIV_OVERFLOW_POSITIVE2) {
  s21_decimal x = {{MAX_INT, MAX_INT, MAX_INT, 0}};
  ...
  ck_assert_int_eq(RESULT_CODE, S21_INFINITY);
  ck_assert_int_eq(s21_is_equal(empty, result_div), 1);
}
END_TEST
...
END_TEST
START_TEST(TEST_DIV_MANUAL_DOUBLE_VALUES12) {
  s21_decimal x = {{5, 0, 0, 0}};
  s21_decimal y = {{4, 0, 0, 0}};
  s21_decimal result_test = {{12, 0, 0, 0}};
  s21_decimal result_div = {0};
  setExponent(&x, 27);
  setExponent(&result_test, 28);
  int RESULT_CODE = s21_div(x, y, &result_div);
...
Suite *st_arithmetic(void) {
  ...
  tcase_add_test(tc, TEST_MUL_MANUAL_DOUBLE_VALUES5);
  tcase_add_test(tc, TEST_MUL_MANUAL_DOUBLE_VALUES6);

  tcase_add_test(tc, TEST_DIV_OVERFLOW_POSITIVE1);
  tcase_add_test(tc, TEST_DIV_OVERFLOW_POSITIVE2);
  ...
  tcase_add_test(tc, TEST_DIV_MANUAL_DOUBLE_VALUES12);
