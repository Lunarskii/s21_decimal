...
s21_decimal int_div(s21_decimal value_1, s21_decimal value_2,
                    s21_decimal *result);
// s21_decimal div_all(s21_decimal value, int *exp, int number);
// int how_much_div_by_5(s21_decimal value);
// int my_div(s21_decimal value_1, s21_decimal value_2, s21_decimal *result);
